...
macro_rules! recurrence {
    ...
    */
    ...
    (a[n]:$dtype:ty = $($inits:expr),+;...;$recur:expr) => {
        // Foremost, we'd expect the transpiler expasion returns an iterator
        {
            struct FibRecurr {
            ...
            // return the iterator constructed to fulfill the original goal
        }
